# HawkesOU-MR-Reinvest-Wide -- HawkesOU-MR-Reinvest with a looser entry.
#
...
#     above the 30-min trailing OU mean (was: must be at-or-below the
...
#
# Reinvest schedule still applies on top: every $500 realized profit
# adds another slot and another top-k candidate.
...
class HftHawkesOuMrReinvestWide(QCAlgorithm):
    def initialize(self):
